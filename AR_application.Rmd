...
Macroeconomics Data Set, Quarterly, 1950I to 2000IV, 204 Quarterly Observations \
...
```{r results="asis"}
lm_phillips <- lm(delta_infl ~ unemp, data = data)
...
```{r}
res <- tibble(res_t=lm_phillips$residuals,
