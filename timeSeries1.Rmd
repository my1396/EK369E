...
```{r AR1, echo=FALSE, out.width = "80%", fig.cap="Simulated AR(1) processes with positive $\\rho$. (a) $\\rho=0.5$, (b) $\\rho=0.95$. Both use the white noise series in Fig.&nbsp;\\@ref(fig:WN)."}
include_graphics(f_name)
```
...
```{r AR1-neg, echo=FALSE, out.width = "80%", fig.cap="Simulated AR(1) processes with negtive $\\rho$. (a) $\\rho=-0.5$, (b) $\\rho=-0.95$. Both use the white noise series in Fig.&nbsp;\\@ref(fig:WN)."}
include_graphics(f_name)
```
