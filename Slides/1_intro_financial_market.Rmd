...
Answer: financial assets. Unlike real assets, cash does not directly produce goods or services. Its value comes from its purchasing power and its function as a medium of exchange and store of value.
...
**Residual value**: the value of a company's assets after all liabilities have been paid. Menging equity investors have lower priority than creditors in the event of liquidation. 

**A futures contract** is an agreement to buy or sell an underlying asset at a specified price on a specified future date. It is an obligation for both sides.

**An option** gives the buyer the right, but not the obligation, to buy or sell an asset at a specified price within/on a specified date. Right for the buyer, obligation for the seller.
...
- An SPE is a separate legal entity created for a specific, limited purpose, often to isolate particular assets, liabilities, or risks.
...
An agency issue (or agency problem) occurs when one party makes decisions on behalf of another party, but their interests are not perfectly aligned.

Shareholders own the company, but managers run it. 
Shareholders (owners) → Managers (agents)
Managers may sometimes make decisions that benefit themselves rather than the shareholders.
...
- Futures contracts do not have any counterparty risk:
  - Because they are standardized and traded on organized exchanges.
...
Dealers move liquidity by buying or selling an asset now even when there isn't an immediate matching buyer or seller, by using their own inventory.

For example:
Today, an investor wants to sell bonds.
There may not be enough buyers at that moment.
A dealer buys the bonds itself, using its own funds.
Later, when another investor wants to buy those bonds, the dealer sells them.
...
- **Initial Public Offering (IPO)** is the first time the company offers shares to the public.

- **Seasoned Equity Offering (SEO)** is the additional issue of shares by a company that is already publicly listed
...
Distinguish SEO from secondary market trading:

- SEO: the company is issuing new shares to raise capital. 
- Secondary market trading: investors are trading existing shares among themselves.
...
- Ideal for assets of a unique nature (heterogeneous and difficult to standardize), *e.g., the real estate market*
...
- Betting against the market: hedging risk.
  
  You own $1 million of stocks and are worried about a market decline. You could short an appropriate index to hedge your risk. If the market falls, your long position loses value, but your short position can offset some of the loss.
