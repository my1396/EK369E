...
$$
IR_p = \frac{\bar{r}_p-\bar{r}_m}{\sigma_{p-m}}
$$
where 
...
# Calculate the value at risk, p is the loss probability level
VaR(ptf_xts$port_ret, p=.025)
VaR(ptf_xts$port_ret, p=.05)


# Calculate the expected shortfall
ES(ptf_xts$port_ret, p=.025)
ES(ptf_xts$port_ret, p=.05)
```
