...
- $\mu_4-3>0$ indicate a [heavy-tailed][] distribution with higher chances of outliers (sharper peak).
- $\mu_4-3<0$ indicate a light-tailed distribution with lower chances of outliers (flatter peak).

Distinguish from standard deviation.
