...
This price is slightly higher than 93.3, so we increase the YTM by 0.1\%\\
\\
@YTM = 8.6\%\\
$P_0 = $ {\Large $6[\frac{1 - (1.086)^{-3}}{0.086}] + \frac{100}{(1.086)^3}$}\\
$P_0 = (6\times 2.5494) + 78.0747 = 93.37$\\
This price is approximately the same as 93.3, we can conclude that the 
\uuline{YTM is approximately 8.6\%}
...
\\
{$93.3x^3 - 6x^2 -6x -106 = 0$} \hspace{4mm}  {\small(\textit{by cross multiplying (or multiply both sides of the the equation above by $x^3$) and equate to zero})}\\
...
\textbf{Bond B}\\
\noindent
Compute the invoice price using the price between coupon dates formula and setting T = 3\\
...
A bond with an annual coupon rate of 8\%, paid semiannually, pays 4\% of its face value every six months. Since the bond sells at par, its semiannual yield to maturity is also 4\%.\\
For a face value of NOK 100, the first NOK 4 coupon can be reinvested for six months at 4\%, earning NOK 0.16. Together with the second NOK 4 coupon, this gives NOK 8.16 at year-end, equivalent to an effective annual yield of 8.16\%.\\
Therefore, to continue selling at par with the same required effective annual yield, the bond must offer an \textbf{annual coupon rate of 8.16\% when coupons are paid once annually}.
...
\\
$P_1^{Bond 2}$ = {\Large $8[\frac{1 - (1.07)^{-9}}{0.07}] + \frac{100}{(1.07)^{9}}$} =  \uuline{106.52}\\
\\
$P_1^{Bond 3}$ = {\Large $10[\frac{1 - (1.07)^{-9}}{0.07}] + \frac{100}{(1.07)^{9}}$} = \uuline{119.55} \\
\\
\\
...
\noindent
\textit{Comments:} \\
When yields fall, bond prices rise, increasing holding period returns compared with unchanged yields. For these bonds with the same maturity and initial yield, the zero-coupon bond is the most sensitive to interest rate changes because all its cash flow occurs at maturity. It therefore experiences the largest percentage price increase from the yield decline and earns the highest holding period return.
\end{document}
